...
// ALTERADO: ID extraído do link fornecido (Macacão)
const ID_MODA_ACADEMIA = '9ca0fcfe-9f06-44db-8c84-f8d395b610ea';
...
async function startSheinImport() {
    ...
    for (const [index, link] of links.entries()) {
        ...
        try {
            ...
            // ALTERADO PARA 80% (1.80)
            const finalPrice = parseFloat((data.rawPrice * 1.80).toFixed(2));
